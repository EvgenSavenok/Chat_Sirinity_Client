...
namespace Chat_Sirinity_Client.Controls.ChatList;

public partial class SearchLineControl : UserControl
{
    public SearchLineControl()
    {
        InitializeComponent();
    }
        ...
        if (e.Key != Key.LeftShift || e.Key != Key.RightShift)
        {
            ...
            if (tb.Text.Length > 0)
            {
                ...
                if (message.Equals("friend\r\nok"))
                    SearchFriendBtn.Visibility = Visibility.Visible;
            }
        }
    }
}
